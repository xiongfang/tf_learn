...
def create_segmentation_model(input_size,output_size, architecture='unet_plus_plus', l=3):
    """
    ...
    """
    model_input = layers.Input(input_size)
    ...
    output_layer = layers.Conv2D(output_size, (1, 1), padding='same', activation='sigmoid', name='output_conv')(model_output)
